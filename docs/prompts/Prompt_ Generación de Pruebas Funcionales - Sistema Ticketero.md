...
│   ├── TicketCreationITest.java  
│   ├── TicketProcessingITest.java  
│   ├── NotificationITest.java  
│   ├── ValidationITest.java  
│   └── AdminDashboardITest.java  
└── config/  
    └── WireMockConfig.java
...
mvn test \-Dtest=TicketCreationITest  
...
class TicketProcessingITest extends BaseIntegrationTest {
...
class NotificationITest extends BaseIntegrationTest {
...
class AdminDashboardITest extends BaseIntegrationTest {
...
Tests por feature:  
\- TicketCreationITest: 6 tests  
\- TicketProcessingITest: 5 tests  
\- NotificationITest: 4 tests  
\- ValidationITest: 5 tests  
\- AdminDashboardITest: 4 tests
...
mvn test \-Dtest=TicketProcessingITest \-X
